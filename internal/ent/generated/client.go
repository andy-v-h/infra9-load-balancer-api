...
func (c *LoadBalancerClient) UpdateOneID(id idx.PrefixedID) *LoadBalancerUpdateOne {
...
func (c *LoadBalancerClient) DeleteOneID(id idx.PrefixedID) *LoadBalancerDeleteOne {
...
func (c *LoadBalancerClient) Get(ctx context.Context, id idx.PrefixedID) (*LoadBalancer, error) {
	return c.Query().Where(loadbalancer.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LoadBalancerClient) GetX(ctx context.Context, id idx.PrefixedID) *LoadBalancer {
...
type (
	hooks struct {
		LoadBalancer []ent.Hook
	}
	inters struct {
		LoadBalancer []ent.Interceptor
	}
)
