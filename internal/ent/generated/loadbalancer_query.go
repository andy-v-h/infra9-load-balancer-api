...
func (lbq *LoadBalancerQuery) FirstID(ctx context.Context) (id idx.PrefixedID, err error) {
...
func (lbq *LoadBalancerQuery) FirstIDX(ctx context.Context) idx.PrefixedID {
...
func (lbq *LoadBalancerQuery) OnlyID(ctx context.Context) (id idx.PrefixedID, err error) {
	var ids []idx.PrefixedID
...
func (lbq *LoadBalancerQuery) OnlyIDX(ctx context.Context) idx.PrefixedID {
...
func (lbq *LoadBalancerQuery) IDs(ctx context.Context) (ids []idx.PrefixedID, err error) {
...
func (lbq *LoadBalancerQuery) IDsX(ctx context.Context) []idx.PrefixedID {
	ids, err := lbq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(loadbalancer.FieldLocationID).
...
//
//	client.LoadBalancer.Query().
//		Select(loadbalancer.FieldLocationID).
//		Scan(ctx, &v)
