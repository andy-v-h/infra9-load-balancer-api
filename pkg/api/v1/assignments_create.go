...
func (r *Router) assignmentsCreate(c echo.Context) error {
	...
	msg, err := pubsub.NewAssignmentMessage("urn:infratographer:infratographer.com:identity:some-jwt", "urn:infratographer:infratographer.com:tenant:"+tenantID, pubsub.NewAssignmentURN(aModel.AssignmentID), "urn:infratographer:infratographer.com:load-balancer:"+feModel.LoadBalancerID)
	if err != nil {
