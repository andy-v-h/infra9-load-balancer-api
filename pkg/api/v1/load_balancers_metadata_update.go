...
func (r *Router) lbMetadataUpdate(c echo.Context) error {
	ctx := c.Request().Context()

	mods, err := r.lbMetadataParamsBinding(c)
	if err != nil {
	...
	return r.updateLBMetadata(c, metadata)
}

// lbMetadataPatch patches an origin
func (r *Router) lbMetadataPatch(c echo.Context) error {
	ctx := c.Request().Context()
...
func (r *Router) updateLBMetadata(c echo.Context, metadata *models.LoadBalancerMetadatum) error {
	ctx := c.Request().Context()
